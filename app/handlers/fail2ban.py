...
from .common import authorized_ids, html_escape, require_admin, send_to_many, ui_error_text, wrap_as_codeblock_html
...
async def f2b_tail_cb(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        if not tail_txt.strip():
            ...
            payload = (
                f"🛡 <b>Fail2ban — {html_escape(srv.label)} · tail</b>\n{SEP}\n"
