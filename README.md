...
- планировать, продлевать, отменять и завершать техработы;
...
Должности сотрудников: специалист поддержки, инженер сопровождения, ведущий инженер сопровождения и руководитель сервиса. Административная роль не заменяет VPN-подписку; исключение — единственный руководитель, которому назначается бессрочный доступ.
...
- `/users`, `/maint`, `/fail2ban` — для администратора;
